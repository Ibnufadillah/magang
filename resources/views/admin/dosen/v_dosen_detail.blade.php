...
<section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 style="font-size: 2.5rem!important;">Detail Dosen</h1>
        </div>
        <div class="col-sm-6">
          ...
          <div class="card "  style="height: 100%">
            <div class="card-body" style="padding-top:3rem">
              <div class="d-flex flex-column align-items-center text-center">
                ...
                <div class="mt-3">
                  <h4>{{ $dosen->nama }}</h4>
                  <p class="text-secondary mb-1">{{ $dosen->getDosenID() }}</p>
                  <p class="text-muted font-size-sm"><i class="fas fa-university"></i> {{ $dosen->mata_kuliah->sum('sks') }} SKS</p>
                </div>
              </div>
            </div>
          </div>
